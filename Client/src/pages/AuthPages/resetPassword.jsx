...
import FoodDeliveryLoader from "../../Components/FoodDeliveryLoader"; // 👈 apna loader yaha import karo
...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    await axiosClient
      ...
      .then(async (res) => {
        ...
        setShowLoader(true); // 👈 loader chalu karo
  ...
  // 👇 agar loader active hai toh sirf loader dikhayenge
  if (showLoader) {
