    ...
    return (
        ...
        <div className="flex w-full justify-between mb-2 pb-2  mt-3 px-2 ">
            ...
            <div className="w-[20%] relative h-36">
                ...
                {
                    count===0?
                    <button onClick={handleAdditems} className="absolute  text-green-600 font-bold px-4 py-2 border-2 rounded-xl bg-white bottom-[-19px] left-17">ADD</button>:
                    <div className="absolute  text-green-600 font-bold px-4 py-2 border-2 rounded-xl bg-white bottom-[-19px] left-10">
                        <button className="px-2 mr-5" onClick={handleDecrementItems}>-</button>
                        <span>{count}</span>
                        <button className="px-2 ml-5" onClick={handleIncrementItems}> +</button>
